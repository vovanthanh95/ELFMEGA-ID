...
class ClientAuthController extends Controller
{
    ...
    {
        $rule = [
            'username' => 'required|max:32|min:6|unique:account,username|regex:/^[a-zA-Z0-9_]+$/i',
            'password' => 'required|max:32|min:8|regex:/^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{6,32}$/i',
        ...
        $message = [
            ...
            'username.max' => 'Tên đăng nhập phải nhỏ hơn 32 kí tự',
