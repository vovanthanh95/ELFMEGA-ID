          ...
          for (i = 1; i <= totalPage; i++) {
            if (i == currentPage) {
              html +=
                '<li class="' +
                classPrefix +
                '-page J-paginationjs-page page-number ' +
                activeClassName +
                '" data-num="' +
                i +
                '"><a>' +
              ...
              html +=
                '<li class="' +
                classPrefix +
                '-page J-paginationjs-page page-number " data-num="' +
                i +
                '"><a href="' +
                pageLink +
                '">' +
        ...
        if (rangeStart <= 3) {
          ...
          if (attributes.showFirstOnEllipsisShow) {
            html +=
              ...
              '-page ' +
              classPrefix +
              '-first J-paginationjs-page page-number " data-num="1"><a href="' +
              pageLink +
              '">1</a></li>';
          }
          html +=
        ...
        if (rangeEnd >= totalPage - 2) {
          ...
          if (attributes.showLastOnEllipsisShow) {
            html +=
              ...
              '-page ' +
              classPrefix +
              '-last J-paginationjs-page page-number " data-num="' +
              totalPage +
              '"><a href="' +
              pageLink +
              '">' +
          ...
          if (showPrevious) {
            if (currentPage <= 1) {
              ...
              html +=
                '<li class="' +
                classPrefix +
                '-prev page-number go-to-prev J-paginationjs-previous" data-num="' +
                (currentPage - 1) +
          ...
          if (showNext) {
            if (currentPage >= totalPage) {
              ...
              html +=
                '<li class="' +
                classPrefix +
                '-next page-number go-to-last J-paginationjs-next" data-num="' +
                (currentPage + 1) +
