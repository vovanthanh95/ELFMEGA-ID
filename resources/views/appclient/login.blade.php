...
<body style="background-color: #ffffff" data-new-gr-c-s-check-loaded="14.1016.0" data-gr-ext-installed="">
    ...
    <div style="padding: 15px;">
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="sign-in">
                <form action="{{ route('post-app-login') }}" id="ctl00" method="post" novalidate="True">
                    @csrf
                    <div class="form-group margin">
                        <input id="login" required="" autofocus="" autocomplete="off" name="username" type="text"
                            placeholder="Tài khoản" class="form-control" value="{{ old('username') }}">
                    </div>
                    <div class="form-group margin">
    ...
    <div id="ContentPlaceHolder1_updateProgress" style="display: none">
        <div
            ...
            <img id="ContentPlaceHolder1_imgUpdateProgress" title="Loading ..." src="./SignInForm_files/loading.gif"
                alt="Loading ..." style="padding: 10px; position: fixed; top: 45%; left: 50%;">
        </div>
    </div>
