            ...
            <div class="col-sm-8 col-md-8 col-lg-9">
                <div class="boxinfo">
                    ...
                    <form id="frmVerify" action="{{route('post-change-email')}}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="v_confirmemail" class="col-sm-3 control-label">{{ __('message.currentemail') }}:</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="v_confirmemail" class="col-sm-3 control-label">{{ __('message.newemail') }}:</label>
                            <div class="col-sm-6">
