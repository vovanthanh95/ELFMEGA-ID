                            ...
                            <div class="loginmodal-container">
                                <div class="conten_login">
                                    <div class="bk-form-login">
                                        <form action="{{ route('post-gift-code') }}" method="post"
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input class="form-control" id="code" required autofocus
                                                            autocomplete="off" name="code" type="text"
                                                            value="{{ old('code') }}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    ...
                                                    <div id="charList" class="col-sm-6">
                                                        <select class="select-list form-control" name="rid"
                                                            id="rid"></select>
                                                    </div>
                                                </div>
                                            </div>
